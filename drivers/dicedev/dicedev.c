...
#define DICEDEV_DEVICE_ID 		0x011

// BAR registers
#define DICEDEV_CTL_INTR		0x0000
#define DICEDEV_CTL_INTR_ENABLE		0x0004
#define DICEDEV_CTL_ENABLE		0x0008
#define DICEDEV_CTL_INCREMENT_SEED	0x000c
#define DICEDEV_CTL_PROC_STATE		0x0010
#define DICEDEV_CMD_MANUAL_FREE 	0x0094
#define DICEDEV_CMD_MANUAL_FEED 	0x0100

// INTR/INTR_ENABLE register bit constants
#define DICEDEV_INTR_FENCE_WAIT		1 << 0
#define DICEDEV_INTR_FEED_ERROR		1 << 1
#define DICEDEV_INTR_CMD_ERROR		1 << 2
#define DICEDEV_INTR_MEM_ERROR		1 << 3
#define DICEDEV_INTR_SLOT_ERROR		1 << 4
